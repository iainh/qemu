...
#define EPIC_AHB_CTRL                 (EPIC_BASE + 0x0f8)
#define EPIC_AHB_MEM                  (EPIC_BASE + 0x0fc)
#define EPIC_AHB_STRIDE               (EPIC_BASE + 0x100)
#define EPIC_VL_SCALE_INIT_H          (EPIC_BASE + 0x114)
#define EPIC_VL_SCALE_INIT_V          (EPIC_BASE + 0x118)
